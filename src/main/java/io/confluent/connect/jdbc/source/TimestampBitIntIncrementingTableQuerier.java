...
public class TimestampBitIntIncrementingTableQuerier extends TableQuerier
        implements CriteriaValues {
  private static final Logger log = LoggerFactory.getLogger(
      TimestampBitIntIncrementingTableQuerier.class
  );

  protected final String bigIntTimestampColumnName;
  ...
  private final ColumnId bigIntTimestampColumn;
  private String incrementingColumnName;
  private final long timestampDelay;
  private final TimeZone timeZone;

  public TimestampBitIntIncrementingTableQuerier(DatabaseDialect dialect, QueryMode mode,
                                                 String name,
                                                 String topicPrefix,
    ...
    this.bigIntTimestampColumnName = bigIntTimestampColumnName;
    this.timestampDelay = timestampDelay;
    this.committedOffset = this.offset = TimestampIncrementingOffset.fromMap(offsetMap);
    this.bigIntTimestampColumn = new ColumnId(tableId, bigIntTimestampColumnName, null);
  ...
  protected void createPreparedStatement(Connection db) throws SQLException {
    ...
    criteria = dialect.criteriaFor(incrementingColumn, Arrays.asList(bigIntTimestampColumn));
    criteria.whereClause(builder);
    criteria.isBigIntTimestamp = true;
  ...
  public void maybeStartQuery(Connection db) throws SQLException, ConnectException {
    if (resultSet == null) {
      ...
      dialect.validateSpecificColumnTypes(metadata, Arrays.asList(bigIntTimestampColumn));
  ...
  public String toString() {
    return "TimestampIncrementingTableQuerier{"
           ...
           + ", incrementingColumn='" + (incrementingColumnName != null
                                        ...
                                        : "") + '\''
           + ", timestampColumn=" + bigIntTimestampColumn
           + '}';
  }
}
